...
FindItemDialog::FindItemDialog(wxWindow* parent, const wxString &title, bool onlyPickupables /* = false*/, bool onSelection /* = false*/) :
	...
	wxString radioBoxChoices[] = { "Find by Client ID",
								   "Find by Name",
								   "Find by Types",
								   "Find by Tile Types",
								   "Find by Properties" };
	...
	optionsRadioBox->SetSelection(SearchMode::ClientIDs);
...
void FindItemDialog::RefreshContentsInternal() {
	...
	if (selection == SearchMode::ClientIDs) {
